  ...
  return (
    <div className="py-20 bg-[#070e29]">
      <div className="flex justify-center flex-col px-3 md:px-0 items-center">
        ...
        <p className="md:text-lg mt-2 tezt-[16px] text-center text-slate-200">
        ...
        <p className="mt-5 md:text-2xl text-lg font-sans text-white">
          or call{" "}
